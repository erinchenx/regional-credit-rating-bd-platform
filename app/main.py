...
CITY_COORDS = {
    ...
    # --- 广西壮族自治区（14个地级市） ---
    "南宁市": (108.33, 22.84), "桂林市": (110.28, 25.29), "柳州市": (109.41, 24.33),
    "梧州市": (111.30, 23.47), "北海市": (109.12, 21.48), "防城港市": (108.35, 21.62),
    "钦州市": (108.62, 21.96), "贵港市": (109.60, 23.10), "玉林市": (110.15, 22.64),
    "百色市": (106.62, 23.90), "贺州市": (111.55, 24.41), "河池市": (108.06, 24.70),
    "来宾市": (109.23, 23.73), "崇左市": (107.35, 22.41),

    # --- 福建省（9个地级市） ---
    "福州市": (119.30, 26.08), "厦门市": (118.10, 24.46), "莆田市": (119.01, 25.43),
    "三明市": (117.64, 26.27), "泉州市": (118.58, 24.93), "漳州市": (117.66, 24.51),
    "南平市": (118.18, 26.64), "龙岩市": (117.03, 25.10), "宁德市": (119.52, 26.66),

    # --- 辽宁省（14个地级市） ---
    "沈阳市": (123.43, 41.80), "大连市": (121.62, 38.92), "鞍山市": (122.99, 41.11),
    "抚顺市": (123.96, 41.88), "本溪市": (123.77, 41.30), "丹东市": (124.38, 40.13),
    "锦州市": (121.13, 41.10), "营口市": (122.23, 40.67), "阜新市": (121.66, 42.02),
    "辽阳市": (123.17, 41.27), "盘锦市": (122.07, 41.12), "铁岭市": (123.84, 42.29),
    "朝阳市": (120.45, 41.57), "葫芦岛市": (120.84, 40.71),
